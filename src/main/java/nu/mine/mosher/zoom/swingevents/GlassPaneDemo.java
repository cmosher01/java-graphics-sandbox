...
public class GlassPaneDemo {
    ...
    public static void main(String[] args) throws InterruptedException, InvocationTargetException {
        ...
        javax.swing.SwingUtilities.invokeAndWait(GlassPaneDemo::createAndShowGUI);
    }
}
...
class MyGlassPane extends JComponent implements ItemListener {
    ...
    public void itemStateChanged(ItemEvent e) {
        // CAM: for a GLASS pane, "visible" means "active and intercepting mouse events"
    ...
    private void redispatchMouseEvent(MouseEvent e, boolean repaint) {
        ...
        if (containerPoint.y < 0) { //we're not in the content pane
            ...
            if ((component != null) && (component.equals(liveButton))) {
                ...
                component.dispatchEvent(new MouseEvent(component, e.getID(), e.getWhen(), e.getModifiersEx(), componentPoint.x, componentPoint.y, e.getClickCount(), e.isPopupTrigger()));
            }
        }
