...
public class ExampleController {
    public ExampleController(ExampleModel model, ExampleView view) {
        CounterController independentController = new CounterController(
            model.getIndependent(),
            view.getIndependentView()
        );



        ResettableCounterController targetController = new ResettableCounterController(
            model.getTarget(),
            view.getTargetView()
        );
